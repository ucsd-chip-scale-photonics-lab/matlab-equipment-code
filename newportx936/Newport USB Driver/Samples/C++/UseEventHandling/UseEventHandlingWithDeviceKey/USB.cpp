...
////////////////////////////////////////////////////////////////////////////////
bool USB::OpenDevices (int nProductID)
{
...
//    True for success, false for failure.
////////////////////////////////////////////////////////////////////////////////
bool USB::OpenDevices (int nProductID, bool bUsingDeviceKey)
{
...
////////////////////////////////////////////////////////////////////////////////
int USB::Read (string strDeviceKey, char* lpBuffer, int nLength, unsigned long* lBytesRead)
{
	try
	{
...
//    Zero for success, non-zero for failure.
////////////////////////////////////////////////////////////////////////////////
int USB::Read (int nDeviceID, char* lpBuffer, int nLength, unsigned long* lBytesRead)
{
	try
	{
...
//    Zero for success, non-zero for failure.
////////////////////////////////////////////////////////////////////////////////
int USB::ReadBinary (string strDeviceKey, char* lpBuffer, int nLength, unsigned long* lBytesRead)
{	try
	{
		char szKey[m_knMaxBufferLength];
		StringToChar (szKey, strDeviceKey);
...
//    Zero for success, non-zero for failure.
////////////////////////////////////////////////////////////////////////////////
int USB::ReadBinary (int nDeviceID, char* lpBuffer, int nLength, unsigned long* lBytesRead)
{
	try
	{
		int nStatus = newp_usb_get_ascii (nDeviceID, lpBuffer, nLength, lBytesRead);
...
//    Zero for success, non-zero for failure.
////////////////////////////////////////////////////////////////////////////////
int USB::Write (string strDeviceKey, char* lpBuffer)
{
	try
	{
		char szKey[m_knMaxBufferLength];
...
//    Zero for success, non-zero for failure.
////////////////////////////////////////////////////////////////////////////////
int USB::Write (int nDeviceID, char* lpBuffer)
{
	try
	{
...
//    Zero for success, non-zero for failure.
////////////////////////////////////////////////////////////////////////////////
int USB::Write (string strDeviceKey, string strBuffer)
{
	try
	{
...
//    Zero for success, non-zero for failure.
////////////////////////////////////////////////////////////////////////////////
int USB::Write (int nDeviceID, string strBuffer)
{
	try
	{
		char szBuffer[m_knMaxBufferLength];
...
////////////////////////////////////////////////////////////////////////////////
void USB::StringToChar (char* lpDest, string strSrc)
{
...
////////////////////////////////////////////////////////////////////////////////
map <string, int> USB::GetDeviceTable ()
{
...
////////////////////////////////////////////////////////////////////////////////
vector<DevInfo> USB::GetDevInfoList ()
{
...
////////////////////////////////////////////////////////////////////////////////
void USB::FillDevInfoList (char* lpDevInfo)
{
	try
	{
		DevInfo devInfo;
...
//    True for success, false for failure.
////////////////////////////////////////////////////////////////////////////////
bool USB::CreateDeviceKey (int handle, string& strDeviceKey)
{
	int nStatus = Write (handle, (string) "*IDN?");
...
//					for I/O operations.
////////////////////////////////////////////////////////////////////////////////
void USB::ParseDeviceKey (char* lpID, string& strDeviceKey)
{
	int nCount = 0;
	char szDelimiters[] = " ";
	char* pNextToken;
