...
////////////////////////////////////////////////////////////////////////////////
// This is the main function.  It opens all power meters on the USB bus, 
// retrieves the device information from the USB driver, performs a write, a 
// read, and then closes all devices.
////////////////////////////////////////////////////////////////////////////////
void main ()
{
	...
	long lOpenStatus = newp_usb_init_product (0xCEC7);
