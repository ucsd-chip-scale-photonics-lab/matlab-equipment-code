classdef NKTControl < handle
    ...
    %Public methods
        ...
        function [] = enableRF(obj, doEnable, options)
            ...
            sendAddr = getRFAddr(obj, options.RFChannel);
            sendRegister = '30';
            if doEnable, sendValue = '01'; else, sendValue = '00'; end
            sendData = [sendRegister; sendValue];
            obj.sendTelegram(sendAddr, obj.msgWrite, sendData);
            obj.getTelegram(8);
        end
