function [measured_V, measured_I, measured_P] = kes_do_P_sweep(...
    kes, p_min, p_max, p_step, v_comp, i_comp, settle_time, function_handle)
...
% Returns:
    ...
    resistance = kes_measure_resistance(kes);
